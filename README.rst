...
Python program to parse various system configuration outputs and provide query tools to those.
...
auditbot will now be installed to the standard location for third-party Python modules on your
computer platform.
